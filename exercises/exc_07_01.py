...
def FCN_16():
    ...
    # Branch
    conv_4_pred = layers.Conv2D(__________,1, activation="relu", padding="same") (_________)
    ...
    add = layers.Add()([conv_4_pred, __________])

    conv = layers.Conv2D(num_classes,1, activation=_________, padding="same") (add) #filter size
    
    upsampling = layers.UpSampling2D(__________) (conv)
